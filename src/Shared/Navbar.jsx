...
const Navbar = () => {
    ...
    const Links = <>
        ...
        <NavLink to={'/howitworks'} className={'btn     text-base-content mr-5'}>How It Works </NavLink>
        <NavLink to={'/SuccessStories'} className={'btn     text-base-content mr-5'}>SuccessStories </NavLink>
            ...
            <div className="navbar bg-base-100 shadow-sm  ">
                ...
                <div className="navbar-end">
                    ...
                    <div className=" dropdown-profile  relative group flex flex-row-reverse items-center mr-3">
                        ...
                        <span className="text-sm font-medium mr-4 opacity-0 lg:group-hover:opacity-100 transition-opacity">
                            {user?.displayName}
                        </span>
